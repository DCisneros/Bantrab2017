...
namespace WindowsFormsApp1
{
    public partial class Plataforma_TI_grid : Form
    {
        ...
        {
            Plataforma_TI a = new Plataforma_TI(dataGridView1, id_infra, nombre_infra, mante, id_marca, id_modelo, id_so, id_rol, id_dominio, id_tipo, id_gabinete, id_ubicacion, id_prov_man, id_cluster, Editar, modificar);
